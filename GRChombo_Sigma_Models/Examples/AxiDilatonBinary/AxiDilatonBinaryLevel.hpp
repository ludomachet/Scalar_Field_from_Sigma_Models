...
#ifndef AXIDILATONBINARYLEVEL_HPP_
#define AXIDILATONBINARYLEVEL_HPP_
...
{
    friend class DefaultLevelFactory<AxiDilatonBinaryLevel>;
    ...
    // Typedef for axi-dilaton field
    typedef AxiDilaton<AxiDilatonPotential> AxiDilatonWithPotential;
...
#endif /* AXIDILATONBINARYLEVEL_HPP_ */
