...
#include "AxiDilatonBinaryLevel.hpp"
...
void AxiDilatonBinaryLevel::initialData()
{
    CH_TIME("AxiDilatonBinaryLevel::initialData");
    if (m_verbosity)
        pout() << "AxiDilatonBinaryLevel::initialData " << m_level << endl;
...
void AxiDilatonBinaryLevel::preTagCells()
{
...
void AxiDilatonBinaryLevel::computeTaggingCriterion(
...
void AxiDilatonBinaryLevel::specificPostTimeStep()
{
    CH_TIME("AxiDilatonBinaryLevel::specificPostTimeStep");
...
void AxiDilatonBinaryLevel::prePlotLevel()
{
    fillAllGhosts();
    if (m_p.activate_extraction == 1)
    {
